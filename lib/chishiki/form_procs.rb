module Chishiki
  class Form
    def load_procs
      ...
      @mode.store :nav,  111, proc { ch_focus Form.focus.add_leaf
                                     do_modes }
      @mode.store :nav,  100, proc { ch_focus Form.focus.delete_branch }
      @mode.store :nav,  110, proc { ch_focus Form.focus.add_branch
                                     do_modes }
